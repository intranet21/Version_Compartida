...
{
    public class BDI_C_GR_DESTACADOS
    {
        public int N_ID_DESTCADOS { get; set; }
        public string T_VALOR_DESTACADOS { get; set; }
        public int N_ORDEN_DESTACADOS { get; set; }
        public int N_ID_IMG_DESTACADOS { get; set; }
        public bool B_FLAG_DESTACADOS { get; set; }
        public int N_ID_TIPO_ELEMENTO_DESTACADOS { get; set; }
