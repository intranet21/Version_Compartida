    ...
    public partial class Inicio : System.Web.UI.Page
    {
        ...
        private void paintCarrusel()
        {
            try
            {
               ...
               if (list != null) {
                        bool controls = list.Count > (int)EnumNumeric.UNO ?  true: false;
        ...
        private void paintBanners()
        {
            try
            {
                ...
                List<JOIN_BANNER_TIPO_IMAGEN> list = ctrl.listaGetBanners();
                StringBuilder sb = new StringBuilder();
                var liOL = String.Empty;
                int count = 1;
        ...
        private void paintFrecuentes()
        {
            try
            {
                GC.Collect();
                //Se consulta la lista de banners
                List<JOIN_FRECUENTES_TIPO_IMAGEN> list = ctrl.listaGetFrecuentes();
                StringBuilder sb = new StringBuilder();
                var liOL = String.Empty;
                int count = 1;
        ...
        private void paintAplicativos()
        {
            try
            {
                GC.Collect();
                //Se consulta la lista de banners
                List<BDI_C_GR_FRECUENTES> list = ctrl.listaGetAplicativos();
                StringBuilder sb = new StringBuilder();
                var liOL = String.Empty;
                int count = 1;
        ...
        private void paintOpcionesYear()
        {
            ...
            {
                GC.Collect();
                List<BDI_C_GR_CAT_YEAR> list = ctrl.listaGetYear();
                StringBuilder sb = new StringBuilder();
                var liOL = String.Empty;
                int count = 1;
                if (list != null)
